...
class Databasehelper {
  ...
  Future _onCreate(Database db, int version) async{
    ...
    await db.execute(
      'CREATE TABLE IF NOT EXISTS cursando(id INTEGER PRIMARY KEY AUTOINCREMENT, estudante_id INTEGER, disciplina_id INTEGER, FOREIGN KEY(estudante_id) REFERENCES estudante(id), FOREIGN KEY(disciplina_id) REFERENCES disciplina(id))'
    );
  }
}
